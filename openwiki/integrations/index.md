...
- [MCP Integration](mcp.md) - How dcode and Talon discover, validate, authorize, expose, refresh, and manage Model Context Protocol servers. Explains their separate configuration, trust, credential, and session-lifetime boundaries.
...
- [Talon Runtime Host](talon.md) - Talon is an experimental single-assistant host that connects a Deep Agents runtime to messaging channels, durable conversation history, MCP tools, approvals, and scheduled work. This page describes its lifecycle, routing, recovery, persistence, and operational limits.
